...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    public Banner(Context context, int height) {
        this(context, null);
        this.height = height;
    }
...
//        ScrollSpeedManger.reflectLayoutManager(this);
    ...
    public void setViewPager2Height(int height) {
        mViewPager2.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height));
        addView(mViewPager2);
    }
